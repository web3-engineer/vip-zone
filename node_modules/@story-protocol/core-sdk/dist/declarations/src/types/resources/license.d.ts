...
import { FeeInput, LicenseTermsIdInput, LicensingConfigInput, RevShareInput, TokenAmountInput } from "../common.js";
import { TxOptions, WithErc20AndWipOptions, WithTxOptions } from "../options.js";
import { RoyaltyPolicyInput } from "./royalty.js";
/**
...
export type LicenseTermsInput = Omit<LicenseTerms, "defaultMintingFee" | "expiration" | "commercialRevCeiling" | "derivativeRevCeiling" | "royaltyPolicy" | "commercialRevShare"> & {
    /** The default minting fee to be paid when minting a license. */
...
export type MintLicenseTokensRequest = {
    ...
    receiver?: Address;
} & WithTxOptions & WithErc20AndWipOptions;
...
export type SetMaxLicenseTokensRequest = GetLicensingConfigRequest & WithTxOptions & {
    /** The total license token limit, 0 means no limit */
    maxLicenseTokens: TokenAmountInput;
};
export type SetMaxLicenseTokens = {
    maxLicenseTokensData: (LicenseTermsDataInput | {
...
export declare enum PIL_TYPE {
    ...
    COMMERCIAL_USE = 1,
    COMMERCIAL_REMIX = 2,
    CREATIVE_COMMONS_ATTRIBUTION = 3
}
