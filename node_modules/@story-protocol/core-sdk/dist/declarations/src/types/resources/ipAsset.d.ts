...
import { DeadlineInput, FeeInput, IpMetadataAndTxOptions, LicenseTermsIdInput, LicensingConfig, RevShareInput, TokenIdInput } from "../common.js";
import { ERC20Options, TxOptions, WipOptions, WithErc20AndWipOptions } from "../options.js";
import { LicenseTerms, LicenseTermsDataInput } from "./license.js";
import { TokenSpender } from "../utils/token.js";
...
export type RegisterDerivativeRequest = WithErc20AndWipOptions & DerivativeDataInput & {
    txOptions?: TxOptions;
    childIpId: Address;
};
...
export type MintAndRegisterIpAssetWithPilTermsRequest = {
    ...
    recipient?: Address;
} & IpMetadataAndTxOptions & WithErc20AndWipOptions;
...
export type MintAndRegisterIpRequest = IpMetadataAndTxOptions & WithErc20AndWipOptions & {
    spgNftContract: Address;
...
export type RegisterDerivativeAndAttachLicenseTermsAndDistributeRoyaltyTokensRequest = {
    ...
    royaltyShares: RoyaltyShare[];
    txOptions?: Omit<TxOptions, "encodedTxDataOnly">;
} & WithErc20AndWipOptions & WithIpMetadata;
...
export type MintAndRegisterIpAndAttachPILTermsAndDistributeRoyaltyTokensRequest = {
    ...
    recipient?: Address;
    txOptions?: Omit<TxOptions, "encodedTxDataOnly">;
} & WithIpMetadata & WithErc20AndWipOptions;
...
export type TransformedIpRegistrationWorkflowRequest<T extends TransformIpRegistrationWorkflowRequest = TransformIpRegistrationWorkflowRequest> = {
    transformRequest: T;
    contractCall: () => Promise<Hash>;
    encodedTxData: EncodedTxData;
 ...
 * ```
 */
export type RegisterIpAssetRequest<T extends MintNFT | MintedNFT> = WithErc20AndWipOptions & WithIpMetadata & {
 ...
 *
 */
export type RegisterIpAssetResponse<T extends RegisterIpAssetRequest<MintedNFT | MintNFT>> = T extends {
    licenseTermsData: LicenseTermsDataInput[];
    royaltyShares: RoyaltyShare[];
} ? T extends {
    nft: {
...
} ? RegisterIPAndAttachLicenseTermsAndDistributeRoyaltyTokensResponse : MintAndRegisterIpAndAttachPILTermsAndDistributeRoyaltyTokensResponse : T extends {
    licenseTermsData: LicenseTermsDataInput[];
} ? T extends {
    nft: {
        type: "minted";
    };
} ? RegisterIpAndAttachPilTermsResponse : MintAndRegisterIpAssetWithPilTermsResponse : RegisterIpResponse;
/**
 ...
 * ```
 */
export type RegisterDerivativeIpAssetRequest<T extends MintedNFT | MintNFT> = WithErc20AndWipOptions & WithIpMetadata & {
    nft: T;
    /**
     * Authors of the IP and their shares of the royalty tokens.
     *
 ...
 * ```
 */
export type RegisterDerivativeIpAssetResponse<T extends RegisterDerivativeIpAssetRequest<MintedNFT | MintNFT>> = T extends {
    derivData: DerivativeDataInput;
    royaltyShares: RoyaltyShare[];
    nft: {
        type: "minted";
    };
} ? RegisterDerivativeAndAttachLicenseTermsAndDistributeRoyaltyTokensResponse : RegisterIpResponse;
