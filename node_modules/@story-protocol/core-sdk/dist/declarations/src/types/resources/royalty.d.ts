...
import { WithErc20AndWipOptions, WithTxOptions } from "../options.js";
...
export type PayRoyaltyOnBehalfRequest = WithTxOptions & WithErc20AndWipOptions & {
 ...
 */
export declare enum NativeRoyaltyPolicy {
    LAP = 0,
    LRP = 1
}
/**
