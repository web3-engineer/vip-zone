...
export type AbiParametersToPrimitiveTypes_mapped<abiParameters extends readonly AbiParameter[], abiParameterKind extends AbiParameterKind = AbiParameterKind> = Pretty<{
    [key in keyof abiParameters]: AbiParameterToPrimitiveType<abiParameters[key], abiParameterKind>;
}>;
export type AbiParametersToPrimitiveTypes_named<abiParameters extends readonly AbiParameter[], abiParameterKind extends AbiParameterKind = AbiParameterKind, acc extends readonly unknown[] = []> = abiParameters extends readonly [
...
] ? AbiParametersToPrimitiveTypes_named<tail, abiParameterKind, readonly [
    ...acc,
    ...
    ...ToNamedTuple<head1, abiParameterKind>,
    ...ToNamedTuple<head2, abiParameterKind>
] : abiParameters extends readonly [infer head extends AbiParameter] ? readonly [...acc, ...ToNamedTuple<head, abiParameterKind>] : acc extends readonly [] ? abiParameters extends readonly [] ? readonly [] : readonly unknown[] : acc;
